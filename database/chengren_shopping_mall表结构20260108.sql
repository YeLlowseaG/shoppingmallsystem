...
) ENGINE=InnoDB AUTO_INCREMENT=220 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='购物车表';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购买咨询表';
...
-- ----------------------------
-- Table structure for jushuitan_config
-- ----------------------------
DROP TABLE IF EXISTS `jushuitan_config`;
CREATE TABLE `jushuitan_config` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `app_key` varchar(100) NOT NULL COMMENT '聚水潭AppKey',
  `app_secret` varchar(200) NOT NULL COMMENT '聚水潭AppSecret',
  `access_token` varchar(100) DEFAULT NULL COMMENT '生产环境AccessToken',
  ...
  `test_api_url` varchar(200) DEFAULT 'https://dev-api.jushuitan.com/api/open/query.aspx' COMMENT '测试环境API地址',
  `test_app_key` varchar(100) DEFAULT 'b0b7d1db226d4216a3d58df9ffa2dde5' COMMENT '测试环境AppKey',
  `test_app_secret` varchar(200) DEFAULT '99c4cef262f34ca882975a7064de0b87' COMMENT '测试环境AppSecret',
  `test_access_token` varchar(100) DEFAULT 'b7e3b1e24e174593af8ca5c397e53dad' COMMENT '测试环境AccessToken（聚水潭公共测试账号）',
  `test_shop_id` varchar(50) DEFAULT NULL COMMENT '测试环境店铺ID',
  `test_callback_url` varchar(500) DEFAULT NULL COMMENT '测试环境物流同步回调地址',
  `shop_id` varchar(50) DEFAULT NULL COMMENT '生产环境店铺ID',
  `callback_url` varchar(500) DEFAULT NULL COMMENT '生产环境物流同步回调地址',
  ...
  `pull_interval` int DEFAULT '5' COMMENT '拉取物流间隔（分钟）',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='聚水潭配置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='会员等级表';
...
CREATE TABLE `order` (
  ...
  `erp_sync_status` tinyint(1) DEFAULT '0' COMMENT 'ERP同步状态（0-未同步，1-已同步，2-同步失败）',
  `erp_sync_time` datetime DEFAULT NULL COMMENT 'ERP同步时间',
  `erp_order_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'ERP订单ID',
  ...
  `seller_remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '卖家备注',
  ...
  KEY `idx_erp_sync_status` (`erp_sync_status`)
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='订单表';
...
CREATE TABLE `order_item` (
  ...
  `product_id` bigint NOT NULL COMMENT '商品ID',
  `shipping_template_id` bigint DEFAULT NULL COMMENT '运费模板ID（记录下单时商品使用的运费模板）',
  ...
  KEY `idx_product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='订单商品表';
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='订单物流表';
...
CREATE TABLE `order_refund` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `refund_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '退款单号（唯一）',
  `order_id` bigint NOT NULL COMMENT '订单ID',
  ...
  `operator_remark` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作备注',
  `refund_time` datetime DEFAULT NULL COMMENT '退款完成时间',
  `refund_payment_method` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '退款支付方式（原支付方式）',
  `refund_payment_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '退款支付单号',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单退款记录表';
...
CREATE TABLE `order_refund_item` (
  ...
  `product_id` bigint NOT NULL COMMENT '商品ID',
  `product_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品名称（快照）',
  `product_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品编码（快照）',
  `sku_id` bigint DEFAULT NULL COMMENT 'SKU ID（快照）',
  `spec_combination` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SKU规格组合（快照）',
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单退款明细表';

-- ----------------------------
-- Table structure for order_sync_log
-- ----------------------------
...
CREATE TABLE `order_sync_log` (
  ...
  `order_id` bigint NOT NULL COMMENT '订单ID',
  `order_no` varchar(50) NOT NULL COMMENT '订单号',
  `env_type` varchar(20) DEFAULT NULL COMMENT '环境类型：test=测试环境，production=生产环境',
  `sync_type` varchar(20) NOT NULL COMMENT '同步类型（PUSH_ORDER-推送订单，PULL_LOGISTICS-拉取物流，QUERY_ORDER-查询订单，SHIP_CALLBACK-发货回调）',
...
) ENGINE=InnoDB AUTO_INCREMENT=1514 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单同步日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='密码重置验证码记录表';

-- ----------------------------
-- Table structure for payment_api_log
-- ----------------------------
...
CREATE TABLE `payment_api_log` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=202 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='支付接口日志表';
...
CREATE TABLE `payment_record` (
  ...
  `external_trade_no` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '外部交易号（支付宝返回的trade_no或微信返回的transaction_id）',
  ...
  KEY `idx_external_trade_no` (`external_trade_no`)
) ENGINE=InnoDB AUTO_INCREMENT=144 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='支付记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='预存款表';
...
CREATE TABLE `pre_deposit_detail` (
  ...
  `callback_data` json DEFAULT NULL COMMENT '回调数据（JSON格式，保存第三方支付返回的完整数据）',
...
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='预存款明细表';
...
CREATE TABLE `product` (
  ...
  `barcode` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '条码',
  `unit` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '计量单位',
  ...
  `member_price` decimal(10,2) DEFAULT NULL COMMENT '会员价（启用时作为售价）',
  `enable_member_price` tinyint(1) DEFAULT '0' COMMENT '是否启用会员价：0-否，1-是',
  ...
  `shipping_template_id` bigint DEFAULT NULL COMMENT '运费模板ID（关联shipping_template表，为空表示包邮）',
  ...
  KEY `idx_shipping_template` (`shipping_template_id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品表';
...
CREATE TABLE `product_category` (
  ...
  KEY `idx_level` (`level`),
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品分类表';
...
CREATE TABLE `product_favorite` (
  ...
  KEY `idx_user_id` (`user_id`),
  KEY `idx_product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品收藏表';
...
CREATE TABLE `product_review` (
  ...
  KEY `idx_create_time` (`create_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品评价表';
...
) ENGINE=InnoDB AUTO_INCREMENT=160 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品SKU表';
...
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品规格属性表';
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品规格值表';
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品库存表';

-- ----------------------------
-- Table structure for product_sync_log
-- ----------------------------
DROP TABLE IF EXISTS `product_sync_log`;
CREATE TABLE `product_sync_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `product_id` bigint NOT NULL COMMENT '商品ID',
  `product_code` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品编码',
  `product_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品名称',
  `env_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'production' COMMENT '环境类型（test=测试环境，production=生产环境）',
  `sync_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '同步类型（UPLOAD_ITEM-上传商品，UPDATE_ITEM-更新商品）',
  ...
  `request_data` text COLLATE utf8mb4_unicode_ci COMMENT '请求数据（JSON格式）',
  `response_data` text COLLATE utf8mb4_unicode_ci COMMENT '响应数据（JSON格式）',
  ...
  KEY `idx_create_time` (`create_time`),
  KEY `idx_env_type` (`env_type`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品同步日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='定时任务表';

-- ----------------------------
-- Table structure for scheduled_task_execution_log
-- ----------------------------
DROP TABLE IF EXISTS `scheduled_task_execution_log`;
CREATE TABLE `scheduled_task_execution_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  ...
  `error_message` text COMMENT '错误信息',
  `execute_type` tinyint NOT NULL DEFAULT '1' COMMENT '执行类型（1-定时执行，2-手动执行）',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='定时任务执行日志表';
...
CREATE TABLE `shipping_rule` (
  ...
  `region_code` text COLLATE utf8mb4_general_ci COMMENT '地区编码（JSON数组，支持多个地区，格式：[{"provinceCode":"110000","cityCode":"110100","districtCode":"110101"},...]，为空表示默认规则）',
  `region_name` text COLLATE utf8mb4_general_ci COMMENT '地区名称（JSON数组，支持多个地区，格式：[{"provinceName":"北京市","cityName":"北京市","districtName":"东城区"},...]，为空表示默认规则）',
...
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='运费规则表';
...
CREATE TABLE `shipping_template` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='运费模板表';
...
CREATE TABLE `stock_notification` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='缺货登记表';
...
CREATE TABLE `system_config` (
  ...
  `category` varchar(50) DEFAULT NULL COMMENT '配置分类：site-网站基础, payment-支付配置, app-应用配置, mail-邮件配置, order-订单配置, wechat.work-企业微信',
  `sort_order` int DEFAULT '0' COMMENT '排序',
  `status` tinyint DEFAULT '1' COMMENT '状态：0-禁用，1-启用',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统配置表';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='管理员角色关联表';
...
CREATE TABLE `sys_admin_user` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='管理员用户表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1260 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='角色菜单关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='收货地址表';
...
CREATE TABLE `warehouse_address` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_is_default` (`is_default`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='发货地址库表';
