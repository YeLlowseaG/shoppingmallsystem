...
public interface ProductSkuService {
     ...
     * @param userId    当前用户ID（可为空），用于计算 SKU 级别的会员价
     * @return SKU列表
     */
    List<ProductSkuVO> getSkusByProductId(Long productId, Long userId);
     ...
     * @param userId          当前用户ID（可为空），用于计算会员价
     * @return SKU详情
     */
    ProductSkuVO getSkuBySpecCombination(Long productId, String specCombination, Long userId);
